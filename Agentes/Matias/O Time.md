...
- Resolver o máximo possível sem interromper a operação
- Escalar apenas o que for estratégico, arriscado ou dependente de autorização
- Traduzir problemas técnicos em impacto de negócio
- Registrar decisões importantes no Obsidian

## Pontos de contato recorrentes

- **Infraestrutura** — servidores, redes, backups e disponibilidade
- **Banco de dados** — Oracle, consultas, performance e integridade
- **Integrações** — Magento, RD Station, Intelipost, sistemas internos
- **Segurança** — acesso, auditoria, permissões e prevenção de incidentes
