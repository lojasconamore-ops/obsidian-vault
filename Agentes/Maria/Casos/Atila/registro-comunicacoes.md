...
caso: Átila
tipo: log
data-inicio: 13/06/2026
responsavel: Maria (RH)
tags: [log, comunicacoes, atila]
---

# Registro de Comunicações — Caso Átila

> **Log oficial** de todo contato entre RH/empresa e o colaborador Átila (e entre RH e o Jurídico sobre o caso).
> Não apagar entradas. Não editar entradas passadas — se errar, criar nova entrada corrigindo.

## Legenda de tipo

- **TLF** — ligação telefônica
- **WPP** — WhatsApp
- **EML** — e-mail
- **VÍD** — vídeo
- **PRE** — presencial
- **JUR** — comunicação interna com Adrian (Jurídico)
- **OUT** — outro (descrever)

---

## #001 — Abertura do caso

- **Data:** 13/06/2026
- **Tipo:** JUR
- **De/Para:** Maria (RH) ← Adrian (Jurídico)
- **Assunto:** Recebimento do documento completo do caso
- **Resumo:** Adrian entrega `[[Agentes/Adrian/Caso Átila - Documento Completo para RH]]`. Maria abre dossiê interno, plano de ação e templates.
- **Anexos/links:** `[[_indice-caso]]`, `[[plano-acao-rh]]`
- **Próximo passo:** preparar primeira conversa com o Átila até 15/06.

<!-- Adicionar novas entradas abaixo desta linha, na ordem cronológica. -->

## #002 — Mensagem do colaborador solicitando orientação

- **Data da comunicação:** 28/05/2026, 13:23 a 13:34
- **Data do registro no dossiê:** 23/07/2026, 21:27 BRT
- **Tipo:** WPP
- **De/Para:** Antonio Átila → Isabel (RH/empresa)
- **Assunto:** Pedido de orientação por ausência de salário/benefício INSS durante afastamento
- **Resumo:** Átila informou estar há aproximadamente 3 meses / quase 90 dias sem salário e aguardando o INSS, mencionou que havia entregado documentos à empresa e que mantinha vínculo empregatício. Solicitou orientação, ligação ou atendimento presencial para tratar do caso. Também mencionou que, sem apoio/orientação, poderia acionar especialista em direito.
...
## #004 — Mensagem sobre dor no braço, atraso e referência a recurso INSS

- **Data da comunicação:** 28/07/2026, 07:17 a 07:31 BRT (captura recebida no Workspace RH em 28/07/2026)
- **Tipo:** WPP
- **De/Para:** Antonio Átila → Chaine/empresa; resposta da empresa ao colaborador
- **Assunto:** Dor no braço, atraso ao trabalho e pendência/expectativa de recurso junto ao INSS
- **Resumo:** Na parte inferior da captura, Átila informa: “Boa dia Chaine, amanheci com muita dor no braço, vou atrasar. pq está muito dolorido, talvez tenha dormido por cima.” A resposta visível da empresa foi acolhedora: “Oie Átila bom dia / Td bem?” e “Combinado / Melhoras”. A mesma captura preserva conversa anterior em que Átila diz estar aguardando 30 dias após recurso no INSS e, se não aprovado, “vou ter procurar outros caminhos”. Há também trecho parcialmente visível sobre orientação de advogado previdenciário, atestado de 60 dias, impossibilidade de trabalhar e ausência de recebimento de valores.
