...
# Dossiê Mestre — Caso Átila

> Referência principal do caso, conforme orientação de Sérgio em 23/07/2026. Documento interno e confidencial do RH.

## Arquivo fonte preservado

- `Documentos/Dossie-Mestre-Caso-Atila-Conamore-2026-07-23.docx`
- SHA-256: `d6f927acf28efeba3aa4afb75e6b3221f28285c0204ac59fe4693d078d5338de`

## Resumo executivo

O caso envolve o colaborador **Antonio Átila Lima Oliveira de Carvalho**, cargo **Cortador**, setor **Produção — Corte de Tecidos**, em razão de acidente de trabalho ocorrido em **24/02/2026** ao carregar rolo de tecido.
...
- Carga zero.
- Não realizar movimento repetitivo com membro superior direito.
- Não realizar esforço intenso.
- Realizar nova avaliação laboral após 30 dias.

## Conduta RH obrigatória

- Designar somente atividade compatível com as restrições.
- Formalizar termo de ciência de retorno com restrições.
- Orientar gestor imediato por escrito.
- Impedir tarefas ocasionais incompatíveis com as restrições.
- Disponibilizar canal para comunicação imediata de dor, limitação ou incompatibilidade.
- Agendar e documentar nova avaliação ocupacional ao final dos 30 dias.

## Pendências principais

- Resultado do recurso administrativo do primeiro requerimento do INSS.
- Resultado do novo pedido protocolado com o atestado de 19/05/2026.
- Cópia integral de eventual processo judicial e respectivas decisões, se existir.
- Data efetiva de retorno ao trabalho e atividade adaptada atribuída.
