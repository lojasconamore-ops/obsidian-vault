...
# Documentos recebidos — Caso Átila

> Documento interno e confidencial do RH. Contém dados pessoais, médicos e ocupacionais. Uso restrito ao RH, Jurídico e profissionais autorizados.

## Arquivos preservados no vault

| Data de guarda | Arquivo | Tipo | Origem | Observação | SHA-256 |
|---|---|---|---|---|---|
...
**Colaborador:** Antonio Átila Lima Oliveira de Carvalho  
**Empresa:** Conamore BRG Cama Mesa e Banho Ltda.  
**Setor/Cargo:** Produção — Corte de Tecidos / Cortador  
**Data do encaminhamento:** 20/07/2026  
**Destino:** À empresa

### Conteúdo relevante

O documento registra o colaborador como **apto com restrição** por 30 dias, com as seguintes limitações:

- **carga zero**;
- não realizar **movimento repetitivo com membro superior direito**;
- não realizar **esforço intenso**;
- após o período, passar por **nova avaliação laboral**.
