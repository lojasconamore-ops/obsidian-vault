# O Time — Estrutura Organizacional

## Hierarquia

```
Sergio Ladeira (CEO) ←→ Camila Ladeira (Presidente Conselho)
         │
    DigitalCEO
         │
    ┌─────┼─────┬─────┬─────┬──────┬──────┐
  ...
  (RH)  (Fin) (Log) (Com)   (Fab)   (Jur)
       ...
       Matias (TI)
         │
       Elias (Secretário — reporta ao Sérgio, fora da hierarquia)
```
...
- Comunicação interna
- Employer branding
- Treinamento de marketing para equipe

### Elias (Secretário Executivo)
- Briefings executivos
- Agenda de Sergio para temas de RH
