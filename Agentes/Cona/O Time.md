...
### Flávia — Marketing
- **Perfil:** `marketing`
- **Telegram:** @flavia_conamore_bot (próprio)
- **Foco:** RD Station, campanhas, funil, conteúdo
- **Reporta:** ao DigitalCEO

### Tobias — Logística / Supply Chain
- **Perfil:** `tobias`
- **Telegram:** @tobias_conamore_bot
- **Foco:** Estoque, transportadoras, Intelipost, fretes
- **Reporta:** ao DigitalCEO

### Tiago — Financeiro
- **Perfil:** `tiago`
- **Telegram:** @tiago_conamore_bot
- **Foco:** Fluxo de caixa, contas, DRE, custos
- **Reporta:** ao DigitalCEO

### Elias — Secretário Executivo
- **Perfil:** `elias`
- **Telegram:** @elias_conamore_bot
- **Foco:** Agenda de Sergio e Camila, viagens, família
- **Reporta:** ao Sérgio (não ao DigitalCEO)
