...
- **Atenção:** o equipamento permanece offline e sem nova telemetria desde 29/07; os 0,0 kWh de ontem e hoje são históricos confirmados pela API, mas não há leitura em tempo real.
