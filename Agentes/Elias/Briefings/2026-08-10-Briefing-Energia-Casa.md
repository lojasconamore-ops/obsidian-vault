# Energia da casa — 2026-08-10

- **Planta:** Sergio Silva Ladeira (`1350678`)
- **Fonte:** API pública Growatt (`growatt_public_api`, `https://openapi.growatt.com`)
- **Status do dispositivo:** offline (`DEVICE_OFFLINE`)
- **Geração de ontem (2026-08-09):** 0,0 kWh
...
- **Potência em tempo real:** indisponível; a API retornou `DEVICE_OFFLINE`.
- **Atenção:** dispositivo offline e telemetria sem atualização desde 29/07; os históricos consultados continuam acessíveis.
