# Parecer de Crédito — DELUZ HOTEL LTDA
...
| Campo | Valor |
|---|---|
| Razão Social | DELUZ HOTEL LTDA |
| CNPJ | 37.068.703/0001-61 |
| ID_DEBX | A0418 |
| Endereço | AV PRESIDENTE VARGAS, 4824 - Jardim do Lago, Aparecida do Taboado/MS |
| Abertura | 05/05/2020 (6 anos) |
| Capital Social | R$ 50.000,00 |
| Porte | Micro Empresa |
| CNAE | Hotéis |
| Contato | Luciane — (67) 3565-2997 / (67) 8173-6320 |
| Email | deluzhoteldh@gmail.com |
...
| Campo | Valor |
|---|---|
| Total Itens | R$ 3.041,30 |
| Frete | R$ 50,00 |
| Total Pedido | R$ 3.091,30 |
| Condição | **ENTRADA 50% + SALDO 30/60 DIAS** |
| Exposição Líquida | **R$ 1.545,65** |
| Mix | Lençóis (King, Solteiro, c/ e s/ elástico), Fronhas, Cobertores — Linha Classic Percal 200 Fios |
...
### Etapa 0 — Lista Negra
✅ **NÃO CONSTA.** CNPJ, razão social e nome fantasia não foram encontrados na lista negra Conamore.

### Etapa 1 — Histórico Interno Conamore
⚠️ **PRIMEIRA COMPRA — SEM HISTÓRICO.**
- `conamore.Customers`: cadastro localizado (A0418, Status=0 ativo)
...
### Etapa 4 — Exposição
- Exposição líquida: **R$ 1.545,65** (50% de R$ 3.091,30)
- Classificação: **BAIXA** — valor muito pequeno, risco financeiro mínimo.
...
| Fonte | Evidência |
|---|---|
| Google Maps | 4.7★, fotos do hotel, $45/noite |
| Booking.com | Listado com avaliações |
| Priceline | Listado |
| TripAdvisor | Página de avaliações |
| Kayak / Trivago | Listado |
| Instagram | @deluzhotel_ |
| Endereço | Consistente entre CNPJ, Google Maps e PDF |

Hotel real, operando, com presença em múltiplas plataformas de reserva.
...
Condição recomendada: ENTRADA 50% + SALDO 30/60 DIAS (condição solicitada pelo cliente)
...
|---|---|---|---|
| Entrada | 50% | R$ 1.545,65 | Na emissão |
| 30 dias | 25% | R$ 772,83 | ~01/08/2026 |
| 60 dias | 25% | R$ 772,83 | ~31/08/2026 |
