...
## Score / Bureau (Etapa 2)

| Indicador | Valor | Classificação |
|-----------|-------|---------------|
| Score PJ | **703** | 🟢 Forte (700–749) |
| Probabilidade de Inadimplência | **6,0%** | 🟡 Administrável (6–8%) |
| Cadastro Positivo | **Participante c/ informações** | 🟢 Muito positivo |
| Protestos | **1** (R$ 424,10) | ⚠️ Valor baixo, único registro |
| Pendências / Restrições | **Nada consta** | 🟢 Limpo |
| Cheques | **Nada consta** | 🟢 Limpo |
...
## Exposição Real (Etapa 4)

| Item | Valor |
|------|-------|
| Total do pedido | R$ 11.119,70 |
| Frete | R$ 250,00 |
| Produtos | R$ 10.869,70 |
| Entrada | **R$ 0,00** |
...
## Validação Operacional Online (Etapa 5)
