...
- [Tobias](./Tobias/Index.md) — gerente de logística e supply chain
- [Tiago](./Tiago/Index.md) — gerente financeiro
- [Elias](./Elias/Index.md) — secretário executivo
- [Adrian](./Adrian/Index.md) — jurídico
- [Maria](./Maria/Index.md) — RH
- [Matias](./Matias/Index.md) — TI
...
- [Governança dos Agentes](../Governança%20dos%20Agentes/Index.md) — política, scorecard e revisão semanal da frota
...
- Nenhum no momento. Os agentes principais já possuem índice mínimo.

> Este índice cresce conforme a documentação de cada agente é consolidada no padrão da Conamore.
