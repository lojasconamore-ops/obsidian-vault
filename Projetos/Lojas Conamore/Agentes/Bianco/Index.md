# Bianco | Lojas Conamore

## Papel

O **Bianco** é o gerente de compras da Conamore.
...
A documentação detalhada do Bianco já vive no `SOUL.md` do perfil Hermes. Este índice existe só para deixar a navegação do Obsidian clara e consistente.
