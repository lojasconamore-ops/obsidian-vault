# Adrian | Lojas Conamore

## Papel

O **Adrian** é o responsável jurídico da Conamore.
...
A documentação detalhada do Adrian já vive no `SOUL.md` do perfil Hermes. Este índice existe só para deixar a navegação do Obsidian clara e consistente.
